...
description = "Simple controls for using the targeting pod pilot camera while in cockpit view.";
logo = "logo_amp_ca.paa";
logoOver = "logo_amp_ca.paa";
tooltip = "TGP Slew Cockpit Control";
tooltipOwned = "TGP Slew Cockpit Control";
overview = "Simple controls for using the targeting pod pilot camera while in cockpit view.";
author = "Ampersand";
