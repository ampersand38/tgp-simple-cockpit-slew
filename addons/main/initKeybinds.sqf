...
[
    "TGP Cockpit Control","tgp_main_key_slewHMD", // Shift + T
...
[
    "TGP Cockpit Control","tgp_main_key_slewWaypoint","Slew To Waypoint", // Alt + T
    {call tgp_main_fnc_keySlewToWaypoint; false},{},
    [20, [false, false, true]],false
] call CBA_fnc_addKeybind;

[
    "TGP Cockpit Control","tgp_main_key_stabilize", // Ctrl + T
