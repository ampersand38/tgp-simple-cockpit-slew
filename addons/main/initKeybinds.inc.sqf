...
[
    LSTRING(Name),"tgp_main_key_slew", // B
...
[
    LSTRING(Name),"tgp_main_key_slewHMD", // Shift + T
...
[
    LSTRING(Name),"tgp_main_key_slewWaypoint", // Alt + T
...
[
    LSTRING(Name),"tgp_main_key_stabilize", // Ctrl + T
...
[
    LSTRING(Name),"tgp_main_key_ccip", // Ctrl + Alt + T
...
[
    LSTRING(Name),"tgp_main_key_zoom_inc","str_usract_zoom_in", // PLUS
    {[1] call tgp_main_fnc_zoomTurret},{},
    [13, [false, false, false]],false
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),"tgp_main_key_zoom_desc","str_usract_zoom_out", // MIN
    {[-1] call tgp_main_fnc_zoomTurret},{},
    [12, [false, false, false]],false
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_TakeControls),"STR_action_take_control", // Unbound
    {[] call FUNC(takeControls)},{}
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_CollisionLightsOn),"STR_ACTION_COLLISIONLIGHTS_ON", // Unbound
    {[true] call FUNC(setCollisionLights)},{}
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_CollisionLightsOff),"STR_ACTION_COLLISIONLIGHTS_OFF", // Unbound
    {[false] call FUNC(setCollisionLights)},{}
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_CollisionLightsToggle),LSTRING(CollisionLightsToggle), // Unbound
    {[] call FUNC(setCollisionLights)},{}
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_toggleRenderTargets),[LSTRING(PIPToggle),LSTRING(PIPToggle_ToolTip)], // Unbound
    {[cameraOn, PIPSTATE_TOGGLE] call FUNC(toggleRenderTargets)},{}
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_toggleLaser),[LSTRING(toggleLaser),LSTRING(toggleLaser_ToolTip)], // Unbound
    {[cameraOn] call zen_common_fnc_setVehicleLaserState},{}
] call CBA_fnc_addKeybind;

[
    LSTRING(Name),QGVAR(key_focusGunnerView),[LSTRING(focusGunnerView),LSTRING(focusGunnerView_Tooltip)], // Unbound
    {
        with uiNamespace do {
